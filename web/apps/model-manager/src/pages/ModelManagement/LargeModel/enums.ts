...
export const MENU_SORT_ITEMS: MenuProps['items'] = [
  ...
  { key: 'update_time', label: intl.get('ModelManagement.sortByUpdate') },
];

export const MODEL_TYPE_OPTIONS = [
  { value: 'llm', label: intl.get('ModelManagement.model_LLM') },
  { value: 'rlm', label: intl.get('ModelManagement.model_RLM') },
  { value: 'vu', label: intl.get('ModelManagement.model_VU') },
];
