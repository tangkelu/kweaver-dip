...
const Callbacks = props => {
  const { callbacks, getComponent, specPath } = props;
  ...
  const callbackElements = callbacks.entrySeq().map(([callbackName, callback]) => {
    return (
  ...
  return <div>{callbackElements}</div>;
};
